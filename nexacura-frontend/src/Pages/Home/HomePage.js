...
import AiTherapy from "../../assets/ai-therapy.jpg";
...
function HomePage() {
  ...
  return (
    <div className={`${isDark ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
      {/* First Section */}
      <div className={`grid grid-cols-1 lg:grid-cols-2 gap-16 px-10 xl:px-32 pt-24 pb-32 relative ${isDark ? "bg-custom-image-dark" : "bg-custom-image"}
  bg-center bg-cover "text-white" `}>
        <div className="flex flex-col gap-y-3 z-10 order-2 lg:order-1">
          ...
          <Text className={`text-base text-white ${fontSize}`} size="txtPoppinsRegular20" htmlTag="h3">
            Connect with understanding and empathy from the comfort of your own space. Our AI psychologist, crafted with cutting-edge technology, provides confidential support to help you navigate through trauma and situations you feel you can't discuss with others. Engage in meaningful, private conversations to find solace and understanding, anytime you need it.
          </Text>
          <div>
            <NavLink to="/register">
            <OutlineButton
...
>
  Experience confidential and compassionate guidance from our AI psychologist anytime you need it. Engage in private conversations from the comfort of your home. Our advanced AI technology ensures a discreet and supportive environment, helping you work through personal challenges without judgment.
</Text>
    ...
    />  
        ...
        <div className="order-first lg:order-last">
          <img src={`${isDark? AiTherapy: Thinking}`} alt="Thinking" className="object-cover h-full w-full rounded-lg shadow-lg" />
        </div>
      </div>
...
<Text
  ...
  className={`text-center text-lg ${
    fontSize === "text-lg" ? "text-xl" : ""
  } mt-3 ${isDark ? "text-gray-300" : "text-gray-600"}`}
>
  "Our AI technology enhances the therapy experience by providing timely and accurate responses, ensuring you receive the support you need exactly when you need it."
</Text>

      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 px-10 mt-10 xl:px-32">
        <MoreCard
